...
class PaginatorTestCase(BootstrapTestCase):
    ...
    def test_paginator_extra_css(self):
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page extra_classes="custom-pagination" %}', {"page": self.paginator.page(2)}
            ),
            (
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page extra_classes="my-custom-class another-class" %}',
    ...
    def test_paginator_extra_classes_with_size(self):
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page size="sm" extra_classes="custom-small" %}',
                {"page": self.paginator.page(2)},
            ),
            (
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page size="lg" extra_classes="large-custom" %}',
                {"page": self.paginator.page(2)},
            ),
            (
    ...
    def test_paginator_extra_classes_with_justify(self):
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page justify_content="center" extra_classes="centered-custom" %}',
                {"page": self.paginator.page(2)},
            ),
            (
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page justify_content="end" extra_classes="end-aligned" %}',
                {"page": self.paginator.page(2)},
            ),
            (
    ...
    def test_paginator_extra_classes_with_all_options(self):
        ...
        self.assertHTMLEqual(
            self.render(
                '{% bootstrap_pagination page size="lg" justify_content="center" extra_classes="all-options-test" %}',
                {"page": self.paginator.page(2)},
            ),
            (
    ...
    def test_paginator_extra_classes_with_url_and_extra(self):
        ...
        html = self.bootstrap_pagination(
            self.paginator.page(2), extra='url="/projects/?foo=bar" extra_classes="url-test-class"'
        )
        self.assertHTMLEqual(
            html,
            (
...
class LargePaginatorTestCase(BootstrapTestCase):
    ...
    def test_paginator_ellipsis_with_extra_css(self):
        ...
        html = self.render(
            '{% bootstrap_pagination page extra_classes="ellipsis-test" %}', {"page": self.paginator.page(33)}
        )
